...
{
	static FileInputStream f;    	// Globally declaring file class from apache.poi dependency,
	//to read data from a file
	static XSSFWorkbook w;       	// Java class in apache.poi library, 
	//used to work with excel files in java
	static XSSFSheet sh;   			// Java class in the apache.poi library,
	//representing a excel work sheet in java
	
	public static String getStringData(int a, int b) throws IOException  // int a, int b - row & column
	{
	f = new FileInputStream("C:\\Users\\HP\\OneDrive\\Desktop\\java\\pgm\\ExcelRead.xlsx");     //object of FileInputStream class
	...
	{		
		f = new FileInputStream("C:\\Users\\HP\\OneDrive\\Desktop\\java\\pgm\\ExcelRead.xlsx");     
